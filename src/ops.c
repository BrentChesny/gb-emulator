...
{
  int a = gameboy->cpu->a;
  if ((gameboy->cpu->f & 0x20) || ((gameboy->cpu->a & 15) > 9))
  {
    gameboy->cpu->a += 6;
  }
  gameboy->cpu->f&=0xEF;
  if((gameboy->cpu->f&0x20)||(a>0x99)) { gameboy->cpu->a+=0x60;
  gameboy->cpu->f|=0x10;
  } gameboy->cpu->m=1;
}
...
void ANDr_b(gb_gameboy* gameboy)
{
  gameboy->cpu->a&=gameboy->cpu->b;
  gameboy->cpu->a&=255;
  gameboy->cpu->f=gameboy->cpu->a?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_b(gb_gameboy* gameboy)
{
  gameboy->cpu->b++;
  gameboy->cpu->b&=255;
  gameboy->cpu->f=gameboy->cpu->b?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_c(gb_gameboy* gameboy)
{
  gameboy->cpu->c++;
  gameboy->cpu->c&=255;
  gameboy->cpu->f=gameboy->cpu->c?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_d(gb_gameboy* gameboy)
{
  gameboy->cpu->d++;
  gameboy->cpu->d&=255;
  gameboy->cpu->f=gameboy->cpu->d?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_e(gb_gameboy* gameboy)
{
  gameboy->cpu->e++;
  gameboy->cpu->e&=255;
  gameboy->cpu->f=gameboy->cpu->e?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_h(gb_gameboy* gameboy)
{
  gameboy->cpu->h++;
  gameboy->cpu->h&=255;
  gameboy->cpu->f=gameboy->cpu->h?0:0x80;
  gameboy->cpu->m=1;
}
...
void INCr_l(gb_gameboy* gameboy)
{
  gameboy->cpu->l++;
  gameboy->cpu->l&=255;
  gameboy->cpu->f=gameboy->cpu->l?0:0x80;
  gameboy->cpu->m=1;
}
...
{
  gameboy->cpu->c=(gameboy->cpu->c+1)&255;
  if(!gameboy->cpu->c) gameboy->cpu->b=(gameboy->cpu->b+1)&255;
  gameboy->cpu->m=1;
}

void INCDE(gb_gameboy* gameboy)
{
  gameboy->cpu->e=(gameboy->cpu->e+1)&255;
  if(!gameboy->cpu->e) gameboy->cpu->d=(gameboy->cpu->d+1)&255;
  gameboy->cpu->m=1;
}

void INCHL(gb_gameboy* gameboy)
{
  gameboy->cpu->l=(gameboy->cpu->l+1)&255;
  if(!gameboy->cpu->l) gameboy->cpu->h=(gameboy->cpu->h+1)&255;
  gameboy->cpu->m=1;
}

void INCSP(gb_gameboy* gameboy)
{
  gameboy->cpu->sp=(gameboy->cpu->sp+1)&65535;
  gameboy->cpu->m=1;
}
...
{
  gameboy->cpu->c=(gameboy->cpu->c-1)&255;
  if(gameboy->cpu->c==255) gameboy->cpu->b=(gameboy->cpu->b-1)&255;
  gameboy->cpu->m=1;
}
...
{
  gameboy->cpu->e=(gameboy->cpu->e-1)&255;
  if(gameboy->cpu->e==255) gameboy->cpu->d=(gameboy->cpu->d-1)&255;
  gameboy->cpu->m=1;
}
...
{
  gameboy->cpu->l=(gameboy->cpu->l-1)&255;
  if(gameboy->cpu->l==255) gameboy->cpu->h=(gameboy->cpu->h-1)&255;
  gameboy->cpu->m=1;
}
...
void BIT0b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x01)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT0m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x01)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT1b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x02)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT1m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x02)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT2b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x04)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT2m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x04)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT3b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x08)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT3m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x08)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT4b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x10)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT4m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x10)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT5b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x20)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT5m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x20)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT6b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x40)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT6m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x40)?0:0x80;
  gameboy->cpu->m=3;
}
...
void BIT7b(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->b&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7c(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->c&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7d(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->d&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7e(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->e&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7h(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->h&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7l(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->l&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7a(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gameboy->cpu->a&0x80)?0:0x80;
  gameboy->cpu->m=2;
}
...
void BIT7m(gb_gameboy* gameboy)
{
  gameboy->cpu->f&=0x1F;
  gameboy->cpu->f|=0x20;
  gameboy->cpu->f=(gb_mmu_rb(gameboy, (gameboy->cpu->h << 8) + gameboy->cpu->l)&0x80)?0:0x80;
  gameboy->cpu->m=3;
}
...
void RLA(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->a&=255;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=1;
}
...
{
  int co=gameboy->cpu->b&0x80?0x10:0;
  gameboy->cpu->b=(gameboy->cpu->b<<1)&255;
  gameboy->cpu->f=(gameboy->cpu->b)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->d&0x80?0x10:0;
  gameboy->cpu->d=(gameboy->cpu->d<<1)&255;
  gameboy->cpu->f=(gameboy->cpu->d)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->h&0x80?0x10:0;
  gameboy->cpu->h=(gameboy->cpu->h<<1)&255;
  gameboy->cpu->f=(gameboy->cpu->h)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->a&0x80?0x10:0;
  gameboy->cpu->a=(gameboy->cpu->a<<1)&255;
  gameboy->cpu->f=(gameboy->cpu->a)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->b&0x80?0x10:0;
  gameboy->cpu->b=(gameboy->cpu->b<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->b)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->c&0x80?0x10:0;
  gameboy->cpu->c=(gameboy->cpu->c<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->c)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->d&0x80?0x10:0;
  gameboy->cpu->d=(gameboy->cpu->d<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->d)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->e&0x80?0x10:0;
  gameboy->cpu->e=(gameboy->cpu->e<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->e)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->h&0x80?0x10:0;
  gameboy->cpu->h=(gameboy->cpu->h<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->h)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->l&0x80?0x10:0;
  gameboy->cpu->l=(gameboy->cpu->l<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->l)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int co=gameboy->cpu->a&0x80?0x10:0;
  gameboy->cpu->a=(gameboy->cpu->a<<1)&255+1;
  gameboy->cpu->f=(gameboy->cpu->a)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->b&0x80;
  int co=gameboy->cpu->b&1?0x10:0;
  gameboy->cpu->b=((gameboy->cpu->b>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->b)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->c&0x80;
  int co=gameboy->cpu->c&1?0x10:0;
  gameboy->cpu->c=((gameboy->cpu->c>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->c)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->d&0x80;
  int co=gameboy->cpu->d&1?0x10:0;
  gameboy->cpu->d=((gameboy->cpu->d>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->d)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->e&0x80;
  int co=gameboy->cpu->e&1?0x10:0;
  gameboy->cpu->e=((gameboy->cpu->e>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->e)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->h&0x80;
  int co=gameboy->cpu->h&1?0x10:0;
  gameboy->cpu->h=((gameboy->cpu->h>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->h)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->l&0x80;
  int co=gameboy->cpu->l&1?0x10:0;
  gameboy->cpu->l=((gameboy->cpu->l>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->l)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
{
  int ci=gameboy->cpu->a&0x80;
  int co=gameboy->cpu->a&1?0x10:0;
  gameboy->cpu->a=((gameboy->cpu->a>>1)+ci)&255;
  gameboy->cpu->f=(gameboy->cpu->a)?0:0x80;
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+co;
  gameboy->cpu->m=2;
}
...
void NEG(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->a&=255;
  if(!gameboy->cpu->a) gameboy->cpu->f|=0x80;
  gameboy->cpu->m=2;
}
...
void CCF(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->f=(gameboy->cpu->f&0xEF)+ci;
  gameboy->cpu->m=1;
}
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x80)==0x00) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m++;
  } else gameboy->cpu->pc+=2;
}

void JPZnn(gb_gameboy* gameboy)
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x80)==0x80) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m++;
  } else gameboy->cpu->pc+=2;
 }
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x10)==0x00) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m++;
  } else gameboy->cpu->pc+=2;
}
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x10)==0x10) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m++;
  } else gameboy->cpu->pc+=2;
 }
...
void JRNZn(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->pc++;
  gameboy->cpu->m=2;
  if((gameboy->cpu->f&0x80)==0x00) { gameboy->cpu->pc+=i;
  gameboy->cpu->m++;
  }
}
...
void JRZn(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->pc++;
  gameboy->cpu->m=2;
  if((gameboy->cpu->f&0x80)==0x80) { gameboy->cpu->pc+=i;
  gameboy->cpu->m++;
  }
 }
...
void JRNCn(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->pc++;
  gameboy->cpu->m=2;
  if((gameboy->cpu->f&0x10)==0x00) { gameboy->cpu->pc+=i;
  gameboy->cpu->m++;
  }
}
...
void JRCn(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->pc++;
  gameboy->cpu->m=2;
  if((gameboy->cpu->f&0x10)==0x10) { gameboy->cpu->pc+=i;
  gameboy->cpu->m++;
  }
 }
...
void DJNZn(gb_gameboy* gameboy)
{
  ...
  gameboy->cpu->m=2;
  gameboy->cpu->b--;
  if(gameboy->cpu->b) { gameboy->cpu->pc+=i;
  gameboy->cpu->m++;
  }
}
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x80)==0x00) { gameboy->cpu->sp-=2;
  gb_mmu_ww(gameboy, gameboy->cpu->sp,gameboy->cpu->pc+2);
  gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m+=2;
  } else gameboy->cpu->pc+=2;
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x80)==0x80) { gameboy->cpu->sp-=2;
  gb_mmu_ww(gameboy, gameboy->cpu->sp,gameboy->cpu->pc+2);
  gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m+=2;
  } else gameboy->cpu->pc+=2;
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x10)==0x00) { gameboy->cpu->sp-=2;
  gb_mmu_ww(gameboy, gameboy->cpu->sp,gameboy->cpu->pc+2);
  gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m+=2;
  } else gameboy->cpu->pc+=2;
...
{
  gameboy->cpu->m=3;
  if((gameboy->cpu->f&0x10)==0x10) { gameboy->cpu->sp-=2;
  gb_mmu_ww(gameboy, gameboy->cpu->sp,gameboy->cpu->pc+2);
  gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->pc);
  gameboy->cpu->m+=2;
  } else gameboy->cpu->pc+=2;
...
{
  gameboy->cpu->m=1;
  if((gameboy->cpu->f&0x80)==0x00) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->sp);
  gameboy->cpu->sp+=2;
  gameboy->cpu->m+=2;
  }
}
...
{
  gameboy->cpu->m=1;
  if((gameboy->cpu->f&0x80)==0x80) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->sp);
  gameboy->cpu->sp+=2;
  gameboy->cpu->m+=2;
  }
}
...
{
  gameboy->cpu->m=1;
  if((gameboy->cpu->f&0x10)==0x00) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->sp);
  gameboy->cpu->sp+=2;
  gameboy->cpu->m+=2;
  }
}
...
{
  gameboy->cpu->m=1;
  if((gameboy->cpu->f&0x10)==0x10) { gameboy->cpu->pc=gb_mmu_rw(gameboy, gameboy->cpu->sp);
  gameboy->cpu->sp+=2;
  gameboy->cpu->m+=2;
  }
}
